...
export default function Calculator() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-white-100 dark:bg-pink-900">
      {}
      <Card className="w-full max-w-md p-6 bg-pink dark:bg-pink-800 shadow-lg rounded-lg">
        {}
        <CardHeader>
